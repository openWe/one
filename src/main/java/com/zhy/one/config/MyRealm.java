package com.zhy.one.config;

import com.zhy.one.dao.ResourceDao;
import com.zhy.one.dao.UserDao;
...
//            info.addStringPermission("user:adminModule");

            // 根据获得认证的用户编号查询该用户具备的资源URL集合
            List<String> resourceurls = resourceDao.findByUserid(user.getId());
