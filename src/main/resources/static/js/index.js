$(function () {
    ...
    function echart_map() {
        ...
        var myData = [
            {name: '....', value: [-100.15, 31.89, 96000]},
            {name: '鄂尔多斯', value: [109.781327, 39.608266, 72800]},
            {name: '招远', value: [120.38, 37.35, 5240]},
            {name: '舟山', value: [122.207216, 29.985295, 12300]}
        ...
        var option = {
            ...
            geo: {
                ...
                itemStyle: { //地图区域的多边形 图形样式。 默认样试。
                    areaColor: '#2c4b8f', //地图区域的颜色。
                    borderColor: '#7fd6fa', //边框线
                },
            ...
            toolbox: {  //工具栏
                show: true,//是否显示工具栏组件
                orient: 'vertical',//'horizontal',//工具栏 icon 的布局朝向
                itemSize: 18,//工具栏 icon 的大小
                itemGap: 9,//工具栏 icon 每项之间的间隔。横向布局时为水平间隔，纵向布局时为纵向间隔
                showTitle: true,//是否在鼠标 hover 的时候显示每个工具 icon 的标题
                left: '88%',//工具栏组件离容器左侧的距离
                top: 9,
                feature: {
